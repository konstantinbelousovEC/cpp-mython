...
![Ops, image should been here](./images/parser.jpg)
...
- lexer_test_open.cpp - набор тестов к лексичсекому анализатору
- parse_test.cpp - набор тестов к синтаксическому анализатору
- runtime_test.cpp - набор тестов к runtime-модулю
- statement_test.cpp - набор тестов к узлам синтаксического дерева
- в main.cpp - также набор общих тестов
